...
class NormlizedMSE(caffe.Layer):
 ...
 #       self.diff = np.zeros(bottom[0].count,dtype='float32')
    ...
    def forward(self, bottom, top):
        ...
        delX = y_true[:,72]-y_true[:,90] # del X size 16    X[:,1] 就是取所有行的第1个数据
...
if __name__ =="__main__":
    print '---------------------------'
    net=caffe.Net('/home/Vanilla-40/ZOO/vanilla_train.prototxt', '/home/Vanilla-40/ZOO/vanilaCNN.caffemodel',caffe.TRAIN)
